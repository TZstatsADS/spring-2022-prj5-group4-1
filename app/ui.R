...
shinyUI(dashboardPage(
  ...
  dashboardSidebar(
    ...
    "))
        ...
        tabItem(tabName = "a", 
                box(width=12,h2(style = "text-align: justify; font-size = 35px;color:black",'Map - Covid Cases per US State'),
              ...
              fluidPage(
                ...
                sidebarLayout(
                  ...
                  # Show map
                  mainPanel(h3(style = "text-align: justify; font-size = 35px;color:black",textOutput("TitleText")),
                    plotlyOutput("map"),
                    h5("Data source:", 
      ...
      tabItem(tabName = "b", 
        fluidPage(actionButton("health","Mental Health Service",icon=icon("hospital",  lib = "font-awesome"),style="color: #fff; background-color: #94a4db; border-color: #94a4db"),
